...
export default function FlagIcon({ type, className = "" }) {
  ...
  switch (type) {
    ...
    case 'eurusd':
      return (
        <div className={`${baseClass} overflow-hidden`}>
          <img src={eurusdIcon.src} alt="EUR/USD" className="w-full h-full object-cover scale-150" />
        </div>
      )
    case 'gbpusd':
      return (
    ...
    case 'btc':
      return (
        <div className={`${baseClass} rounded-full overflow-hidden`}>
          <img src={btcIcon.src} alt="Bitcoin" className="w-full h-full object-cover scale-[1.75]" />
        </div>
      )
    case 'aapl':
      return (
