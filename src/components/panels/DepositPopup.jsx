      ...
      <div className="bg-[#1a2329] rounded-lg shadow-2xl w-[600px] overflow-hidden border border-gray-700 font-sans">
        ...
        <div className="p-6 grid grid-cols-2 gap-6">
          ...
          <div className="flex flex-col h-full">
            ...
            <button className="w-full py-3 bg-[#2d3a45] hover:bg-[#384652] text-white font-bold rounded transition-colors text-sm mt-auto">
              Top up demo account
            </button>
          </div>
          ...
          {/* Real Column */}
          <div className="flex flex-col h-full">
            <h3 className="text-lg font-bold text-white mb-4">Real</h3>
            <ul className="space-y-2 mb-8 flex-grow">
              <li className="flex items-center text-gray-300 text-sm whitespace-nowrap">
                <span className="w-1.5 h-1.5 bg-white rounded-full mr-2 flex-shrink-0"></span>
                Full access to the terminal
