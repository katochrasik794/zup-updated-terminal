import { IBrokerTerminal, Order } from '../../../charting_library/broker-api';
import './index.css';
...
export function createCancelOrderButtonListenerFactory(broker: IBrokerTerminal): CreateCancelOrderButtonListener {
