import { Order, OrderTemplate, PreOrder, IBrokerTerminal } from '../../../charting_library/broker-api';
...
export function createOrderDialog(broker: IBrokerTerminal, onResultCallback: (result: boolean) => void): HTMLElement {
